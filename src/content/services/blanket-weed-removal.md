...
overview:
  ...
  - type: iconListSection
    ...
    items:
      ...
      - icon: leaf
        title: Produce unpleasant odours
      - icon: leaf
        title: Restrict boats and water activities
      - icon: leaf
        title: Reduce sunlight reaching submerged plant life
      - icon: leaf
        title: Clog inlets, outlets, and water features
      - icon: leaf
        title: Hamper fishing and other watersports
  - type: richTextSections
    eyebrow: How We Manage Blanket Weed
    title: Algae Removal & Control
    description: Mechanical removal provides a targeted way to reduce excessive surface algae while limiting disturbance to submerged aquatic plant life.
    items:
      - title: Mechanical Algae Removal
        content: |
          The simplest form of blanket weed control is mechanical removal from the surface of the water. Truxor machinery can skim and collect floating algae, depositing the removed material on nearby banks so that it can be cleared from the site.
      ...
      - title: Addressing Recurring Algae Growth
        content: |
          Recurring algae problems can be associated with nutrient-rich conditions and accumulated silt within the watercourse. Where appropriate, removing silt from the bottom can help reduce the nutrients available to support future algal growth.
      ...
      - type: richTextSection
        ...
        content: |
          Excessive algal growth can sometimes develop into harmful algal blooms (HABs), including blooms commonly associated with blue-green algae. These blooms can produce toxins that pose risks to people, livestock, fish, birds, and other wildlife that come into contact with affected water.
...
callToAction:
  ...
  description: If blanket weed or algae is affecting your lake, pond, or other watercourse, contact us to discuss the problem and the most appropriate approach to removal and control.
  buttons:
    - title: Contact Us
      href: /contact
---
