...
seo:
  ...
  image: ../../assets/images/services/debris.webp
overview:
  - type: pageHeader
    eyebrow: ''
  ...
  - type: richTextSection
    ...
    content: |
      Fallen trees and large timber can completely obstruct a waterway. Our chainsaw-trained operators can work from the Truxor to cut, retrieve, and remove timber and other hard-to-reach debris, clearing obstructions safely and efficiently.
    media:
      type: image
...
callToAction:
  ...
  description: Contact us to discuss debris, rubbish, fallen trees, or other obstructions affecting your watercourse.
  buttons:
    - title: Explore Tree Work
