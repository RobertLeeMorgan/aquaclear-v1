...
overview:
  ...
  - type: iconListSection
    ...
    items:
      ...
      - icon: leaf
        title: Encroach into open water
      - icon: leaf
        title: Increase the risk of flooding
  - type: richTextSections
    eyebrow: How We Manage Bulrush & Bur-reed
    title: Cutting & Clearance
    description: |
      Different levels of bulrush and bur-reed growth require different approaches, from targeted cutting and clearance to the removal of established root and rhizome systems.
    items:
      - title: Cutting & Clearance
        content: |
          Mechanical cutting provides a quick and effective way to reopen areas affected by excessive bulrush and bur-reed growth. Our precision cutting equipment can clear selected areas, create channels, and restore access without requiring the complete removal of marginal vegetation.
      ...
      - title: Root & Rhizome Removal
        content: |
          Bulrush and bur-reed develop extensive root systems and rhizomes beneath the water surface. Where repeated cutting is no longer sufficient, removing this underlying growth can provide a more lasting approach to controlling severe encroachment.
...
callToAction:
  ...
  description: If excessive marginal growth is restricting your watercourse, contact us to discuss the most appropriate approach for your site.
  buttons:
    - title: Contact Us
      href: /contact
---
